#!/usr/bin/env tsx
/**
 * Backfill Missing Week (Dec 9-16, 2025)
 *
 * Fetches and processes financial emails from Dec 9 to Dec 16
 *
 * Usage:
 *   cd ops
 *   npx tsx backfill-missing-week.ts
 */
...
const START_DATE = '2025/12/09'; // December 9, 2025
const END_DATE = '2025/12/16'; // December 16, 2025

class MissingWeekBackfill {
  ...
  private async listMessages(): Promise<string[]> {
    console.log('📬 Fetching message IDs from Dec 9-16, 2025...\n');

    const query = `label:financial after:${START_DATE} before:${END_DATE}`;
  ...
  private printStats(): void {
    ...
    console.log(`Period:                   Dec 9-16, 2025`);
  ...
  async run(): Promise<void> {
    console.log('\n🚀 Starting Missing Week Backfill (Dec 9-16, 2025)\n');
...
// Main execution
const backfill = new MissingWeekBackfill();
